...
﻿using Abp.Owin;
using TakeyourStand.Api.Controllers;
using TakeyourStand.Web;
    ...
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                LoginPath = new PathString("/base/home"),
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in TakeyourStandWebModule)
